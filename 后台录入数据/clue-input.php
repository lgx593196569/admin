...
<div class="content" style="padding-top: 50px;margin-top: 22px;">
	<form class="sui-form form-horizontal sui-validate" action="clue-save.php" method="post" enctype="multipart/form-data" style="margin-left: 120px;">
		...
		<div class="control-group">
			<label for="post" class="control-label">公司:</label>
			<div class="controls">
				<input type="text" id="post" name="post" class="input-large input-fat"  placeholder="输入公司" data-rules="required|minlength=2|maxlength=40">
			</div>
		</div>
		<div class="control-group">
